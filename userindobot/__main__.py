...
from userindobot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL, telethn

from userindobot.modules import ALL_MODULES
from userindobot.modules.helper_funcs.chat_status import is_user_admin
from userindobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("userindobot.modules." + module_name)
