...
if ENV:
    ...
    from userindobot.config import Development as Config
...
telethn = TelegramClient("userindobot", API_ID, API_HASH)
...
from userindobot.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
