...
import userindobot.modules.sql.blacklist_sql as sql
from userindobot import dispatcher, LOGGER
from userindobot.modules.disable import DisableAbleCommandHandler
from userindobot.modules.helper_funcs.chat_status import user_admin, user_not_admin, connection_status
...
__handlers__ = [BLACKLIST_HANDLER, ADD_BLACKLIST_HANDLER,
                UNBLACKLIST_HANDLER, (BLACKLIST_DEL_HANDLER, BLACKLIST_GROUP)]
