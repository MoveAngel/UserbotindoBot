...
import userindobot.modules.sql.connection_sql as sql
from userindobot import dispatcher, SUDO_USERS, DEV_USERS, spamfilters
from userindobot.modules.helper_funcs import chat_status
