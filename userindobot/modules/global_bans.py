...
import userindobot.modules.sql.global_bans_sql as sql
from userindobot import dispatcher, OWNER_ID, SUDO_USERS, DEV_USERS, SUPPORT_USERS, SARDEGNA_USERS, WHITELIST_USERS, STRICT_GBAN, GBAN_LOGS, spam_watch
from userindobot.modules.helper_funcs.chat_status import user_admin, is_user_admin, support_plus
from userindobot.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from userindobot.modules.helper_funcs.misc import send_to_list
from userindobot.modules.sql.users_sql import get_all_chats
...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    try:
        bot.send_message(
            ...
            "If you think that this was a mistake, you may appeal your ban here: @userindobotEagleSupport",
            parse_mode=ParseMode.HTML)
...
*Admin only:*
 - /gbanstat
Note: You can appeal gbans or ask gbans at @userbotindo
UserbotindoBot also integrates @Spamwatch API into gbans to remove Spammers as much as possible from your chatroom!
*What is SpamWatch?*
...
UserbotindoBot will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group.
"""
