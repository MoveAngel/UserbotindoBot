...
from userindobot import dispatcher, WHITELIST_USERS, SARDEGNA_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID
from userindobot.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from userindobot.modules.helper_funcs.extraction import extract_user
from userindobot.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), 'userindobot/elevated_users.json')
...
nations = """ UserbotindoBot has bot access levels we call as *"Nation Levels"* just like Kigyo
...
Owner has complete bot access, including bot adminship in chats UserbotindoBot is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in UserbotindoBot.
\n*Sakuras* - Have access go globally ban users across UserbotindoBot.
...
\n*Disclaimer*: The Nation levels in UserbotindoBot are there for troubleshooting, support, banning potential scammers.
Report abuse or ask us more on these at [UserbotindoBot Support](https://t.me/userbotindo).
"""
...
__help__ = """
 ...
 You can visit @userbotindo to query more about these.
"""
