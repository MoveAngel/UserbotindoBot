...
from userindobot import dispatcher, AI_API_KEY, OWNER_ID
import userindobot.modules.sql.chatbot_sql as sql
from userindobot.modules.helper_funcs.chat_status import user_admin
...
def check_message(bot: Bot, message):
    ...
    if message.text.lower() == "userindobot":
        return True
    if reply_msg:
...
__help__ = """
Chatbot utilizes the CoffeeHouse API and allows UserindoBot to talk back making your chat more interactive.
...
Commands: These only work for UserindoBot Staff users.
