...
from userindobot import dispatcher, LOGGER, DEV_USERS, SUDO_USERS, SARDEGNA_USERS, BAN_STICKER
...
from userindobot.modules.helper_funcs.chat_status import (
    ...
    is_user_in_chat,
    connection_status)
from userindobot.modules.helper_funcs.extraction import extract_user_and_text
from userindobot.modules.helper_funcs.string_handling import extract_time
from userindobot.modules.log_channel import loggable, gloggable
...
def banme(bot: Bot, update: Update):
    ...
    try:
        ...
        response_message = "Ohno! something is not right please contact @userbotindo"
