...
import userindobot.modules.sql.global_bans_sql as gban_sql
import userindobot.modules.sql.users_sql as user_sql
from userindobot import dispatcher, OWNER_ID, DEV_USERS
...
LEAVE_MUTED_CHATS_HANDLER = CommandHandler(
    "leavemutedchats", leave_muted_chats)
